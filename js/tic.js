function myfunc() {
	...
	// Empate
		...
		b8 == 'O') && (b9 == 'X' || b9 == 'O')) {
			document.getElementById('print')
				.innerHTML = "Empate de Partida";
			window.alert('Empate de Partida');
	}
	else {
		...
		if (flag == 1) {
			document.getElementById('print')
				.innerHTML = "Jogador X perdeu";
		}
		else {
			document.getElementById('print')
				.innerHTML = "Jogador O perdeu";
		}
	}
}
